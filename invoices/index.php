                ...
                <?php if (empty($invoices)): ?>
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="create.php" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">Create your first invoice</a>
                        </td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($invoices as $invoice): ?>
                        <tr class="hover:bg-blue-50 transition-colors">
                            <td class="px-6 py-4 font-semibold text-blue-600"><?php echo $invoice['invoice_number']; ?></td>
                            <td class="px-6 py-4 text-gray-700"><?php echo $invoice['customer_name']; ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo formatDate($invoice['invoice_date']); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo formatDate($invoice['due_date']); ?></td>
                            <td class="px-6 py-4 font-semibold text-gray-800"><?php echo formatCurrency($invoice['total_amount']); ?></td>
                            <td class="px-6 py-4">
                                <?php
                                $statusClass = [
                                    'paid' => 'badge-success',
                                ...
                                ?>
                                <span class="badge <?php echo $statusClass[$invoice['status']] ?? 'badge-secondary'; ?>">
