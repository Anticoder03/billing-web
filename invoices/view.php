...
// Get invoice details
$stmt = $conn->prepare("SELECT i.*, c.name as customer_name, c.email as customer_email, c.phone as customer_phone, 
...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6 no-print">
        ...
        <div class="flex space-x-3">
            ...
            <a href="delete.php?id=<?php echo $invoice['id']; ?>" 
               onclick="return confirmDelete('Are you sure you want to delete this invoice?')"
    ...
    <!-- Invoice Content -->
    <div id="invoice-content" class="bg-white rounded-xl shadow-lg p-8">
        <!-- Header -->
        <div class="flex justify-between items-start mb-8 pb-6 border-b-2 border-gray-200">
            ...
            <div class="text-right">
                <h2 class="text-4xl font-bold text-blue-600 mb-4"><?php echo $invoice['invoice_number']; ?></h2>
        ...
        <div class="mb-8">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="font-semibold text-gray-800 text-lg"><?php echo $invoice['customer_name']; ?></p>
                <?php if ($invoice['customer_address']): ?>
                    <p class="text-gray-600"><?php echo $invoice['customer_address']; ?></p>
                    <p class="text-gray-600">
                        <?php echo implode(', ', array_filter([$invoice['city'], $invoice['state'], $invoice['zip_code']])); ?>
                    </p>
                    <?php if ($invoice['country']): ?>
                        <p class="text-gray-600"><?php echo $invoice['country']; ?></p>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($invoice['customer_email']): ?>
                    <p class="text-gray-600 mt-2"><i class="fas fa-envelope mr-2"></i><?php echo $invoice['customer_email']; ?></p>
                <?php endif; ?>
                <?php if ($invoice['customer_phone']): ?>
                    <p class="text-gray-600"><i class="fas fa-phone mr-2"></i><?php echo $invoice['customer_phone']; ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="flex justify-end mb-8">
            <div class="w-full md:w-1/2 lg:w-1/3 space-y-3">
                <div class="flex justify-between items-center pb-2">
                    ...
                    <span class="text-gray-800 font-bold"><?php echo formatCurrency($invoice['subtotal']); ?></span>
                </div>
                
                <?php if ($invoice['tax_rate'] > 0): ?>
                    <div class="flex justify-between items-center pb-2">
                        <span class="text-gray-700 font-semibold">Tax (<?php echo $invoice['tax_rate']; ?>%):</span>
                        <span class="text-gray-800 font-bold"><?php echo formatCurrency($invoice['tax_amount']); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($invoice['discount_amount'] > 0): ?>
                    <div class="flex justify-between items-center pb-2">
                        ...
                        <span class="text-red-600 font-bold">-<?php echo formatCurrency($invoice['discount_amount']); ?></span>
                    </div>
                <?php endif; ?>
                
                <div class="flex justify-between items-center pt-3 border-t-2 border-gray-300">
                    <span class="text-xl font-bold text-gray-800">Total:</span>
                    <span class="text-2xl font-bold text-blue-600"><?php echo formatCurrency($invoice['total_amount']); ?></span>
                </div>
            </div>
        </div>
        ...
        <?php if ($invoice['notes']): ?>
            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-600">
                ...
                <p class="text-gray-700"><?php echo nl2br($invoice['notes']); ?></p>
            </div>
        <?php endif; ?>
...
function downloadPDF() {
    ...
    const opt = {
        margin: 10,
        filename: '<?php echo $invoice['invoice_number']; ?>.pdf',
